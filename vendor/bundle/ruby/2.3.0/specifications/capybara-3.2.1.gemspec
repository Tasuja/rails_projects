...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<xpath>, ["~> 3.1"])
      ...
      s.add_development_dependency(%q<selenium-webdriver>, ["!= 3.4.1", "< 4.0", ">= 3.0"])
      ...
      s.add_dependency(%q<selenium-webdriver>, ["!= 3.4.1", "< 4.0", ">= 3.0"])
